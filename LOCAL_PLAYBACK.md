...
Milestone 6 keeps one Play action throughout Home, libraries, search, details, seasons, and episode rows. The renderer submits only a Jellyfin item ID and receives only sanitized playback state.
